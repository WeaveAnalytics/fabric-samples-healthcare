## Updates April 2025
- Added a quick interactive deployment option. It can use an existing Workspace/Lakehouse or create new ones. It can also start running the data pipeline to load all the files and create the required tables in the bronze, silver, and gold lakers on the Lakehouse.
